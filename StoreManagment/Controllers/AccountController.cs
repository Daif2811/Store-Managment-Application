...
namespace StoreManagment.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [Authorize(Roles ="Admins")]
        [ValidateAntiForgeryToken]
        public ActionResult RegisterByAdmin(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {

                ApplicationUser user = new ApplicationUser();
                ViewBag.UserType = new SelectList(db.Roles, "Name", "Name", model.UserType);
                ...
                UserManager.AddToRoleAsync(user.Id, model.UserType);
        ...
        {
            var users = db.Users.Where(a => a.UserName != "");
            return View(users);
        }
